...
<?php echo $this->Form->create('Company'); ?>
	...
	<?php
		echo $this->Form->input('name',array('label'=>'Nombre','class'=>'input-large'));
		echo $this->Form->input('address',array('label'=>'Direccion','class'=>'input-large'));
		...
		echo $this->Form->input('Item',array('label'=>'Productos','class'=>'input-large'));
		echo $this->Form->input('SubCategory',array('label'=>'Sub Categorias','class'=>'input-large'));
		echo $this->Form->input('Tag',array('label'=>'Etiquetas','class'=>'input-large'));
	?>
	</fieldset>
