...
class Googlemaps {
	...
	function directions($params = array())
	{
	...
	//obtenr lat long por direccion
        //revisar el autocompletado de google direccion
	function get_lat_long_from_address($address, $attempts = 0)
	{
        ...
        function direccion_datos($lat,$lng){
            
        $geocode=file_get_contents('http://maps.google.com/maps/api/geocode/json?address='.$lat.','.$lng.'&sensor=true');
